...
class LimitRequest extends FormRequest
{
    ...
    {
        return [
            'start_date' => 'required|date|before_or_equal:2100/01/01|after_or_equal:2000/01/01',
            'end_date' => 'required|date|before_or_equal:2100/01/01|after_or_equal:start_date',
    ...
    public function messages(): array
    {
        return [
            ...
            'start_date.before_or_equal' => 'Максимальное значение конечной даты 01.01.2100',
            ...
            'end_date.after_or_equal' => 'Минимальное значение конечной даты должно быть больше начальной даты'
        ];
    }
}
